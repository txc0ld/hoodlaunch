...
export type ProAccessState = ProStatus & { sessionIdentity: string | null; configured: boolean; signInAvailable: boolean; walletSignInAvailable: boolean; signedIn: boolean; billing: boolean; billingAccount: boolean; billingAccountUnavailable: boolean };
...
export const EMPTY_PRO_ACCESS: ProAccessState = { sessionIdentity: null, configured: false, signInAvailable: false, walletSignInAvailable: false, signedIn: false, pro: false, billing: false, billingAccount: false, billingAccountUnavailable: false, subscription: false, subscriptionUnavailable: false, holder: EMPTY_HOLDER_ACCESS };
