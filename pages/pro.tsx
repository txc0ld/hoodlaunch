...
export default function Pro() {
 return <main className={styles.page}>
  ...
  <header><p className={styles.eyebrow}>FREE OR {PRO_PRICE_LABEL}</p><h1>Launch free. Scale when you need it.</h1><p>Free includes connected-wallet launching and core planning. Pro adds comparisons, generated wallets and managed uploads.</p></header>
