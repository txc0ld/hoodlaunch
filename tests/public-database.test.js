...
test('Postgres migration denies public data access and quota admission is atomic',async()=>{
 ...
 const keys=await Promise.all(Array.from({length:10},()=>db.query("select public.hood_checkout_reserve('11111111-1111-1111-1111-111111111111', '{\"customer\":\"cus_test\",\"mode\":\"subscription\",\"client_reference_id\":\"11111111-1111-1111-1111-111111111111\"}'::jsonb)->>'key' as key")));
